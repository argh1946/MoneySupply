    ...
    public partial class init1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "تایید نماینده پول رسان" },
                    { 2, "تایید ارتباط فردا" },
                    { 3, "تایید مدیر گروه خزانه" },
                    { 4, "تایید حسابدار خزانه" },
                    { 5, "تایید اداره عملیات" },
                    { 6, "تایید معاون گروه خزانه - تسویه" },
                    { 7, "تایید پول رسان - تسویه" },
                    { 8, "تایید مدیر گروه خزانه - تسویه" },
                    { 9, "تایید حسابدار خزانه - تسویه" },
                    { 10, "تایید اداره عملیات - تسویه" },
                    { 11, "رد نماینده پول رسان" },
                    { 12, "رد ارتباط فردا" },
                    { 13, "رد مدیر گروه خزانه" },
                    { 14, "رد حسابدار خزانه" },
                    { 15, "رد اداره عملیات" },
                    { 16, "رد معاون گروه خزانه - تسویه" },
                    { 17, "رد پول رسان - تسویه" },
                    { 18, "رد مدیر گروه خزانه - تسویه" },
                    { 19, "رد حسابدار خزانه - تسویه" },
                    { 20, "رد اداره عملیات - تسویه" }
                });
